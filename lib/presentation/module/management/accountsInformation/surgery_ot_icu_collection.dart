...
class SurgeryOtIcuCollection extends StatefulWidget {
  @override
  State<SurgeryOtIcuCollection> createState() => _SurgeryOtIcuCollection();
}

class _SurgeryOtIcuCollection extends State<SurgeryOtIcuCollection> {
