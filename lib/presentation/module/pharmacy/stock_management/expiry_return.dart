...
import 'package:foxcare_lite/presentation/module/pharmacy/stock_management/expiry_return_entry.dart';
...
class ExpiryReturn extends StatefulWidget {
  const ExpiryReturn({super.key});

  @override
  State<ExpiryReturn> createState() => _ExpiryReturn();
}

class _ExpiryReturn extends State<ExpiryReturn> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            children: [
              TimeDateWidget(text: 'Expiry Return'),
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  PharmacyButton(
                    label: 'Expiry Return Entry',
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const ExpiryReturnEntry()));
                    },
